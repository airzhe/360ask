	...
	<div class="wrapper">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<form action="?c=category&amp;m=add" class="category_edit" method="post">
					<div class="form-group">
						<label >上级分类</label>
						<input type="text" class="form-control" disabled="disabled"
						<?php if (isset($_data['pname'])): ?>
							value="<?php echo $_data['pname'];?>"
						<?php else: ?>
							value='无'
						<?php endif ?>
						>
					...
					<div class="form-group">
						...
						<input type="hidden" name="pid" value="<?php echo $_data['pid']?>">
